...
(function() {
    ...
    async function processMessage(msg) {
        ...
        const partKeywords = /\b(transmission|engine|alternator|starter|fender|bumper|door|radiator|window|wheel|tire|axle|headlight|taillight|hood|trunk|mirror|seat|dash|steering|brake|suspension|exhaust|fuel|battery|clutch)\b/i;
